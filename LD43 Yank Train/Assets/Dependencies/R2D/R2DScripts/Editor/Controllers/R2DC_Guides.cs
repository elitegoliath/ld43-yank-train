...
{	
    ...
    {	
        ...
        bool IsOnLockButton(Vector2 pos)
        {
            return (pos.x >= viewPixelFrame.width - resources.lockActive.width
                && pos.x <= viewPixelFrame.width 
                && pos.y < viewPixelFrame.height
                && pos.y >= viewPixelFrame.height - 20f);
        }
